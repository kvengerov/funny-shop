...
/**
 * Display component for a single product.
 * Features an image, price, rating, and promotional styling.
 */
@Component({
...
export class ProductCardComponent {
  /** The product data to display in this card */
  product = input.required<Product>();

  /** External CSS classes for layout customization */
